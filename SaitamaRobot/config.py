...
class Config(object):
    ...
    API_ID = 4769821  # integer value, dont use ""
    API_HASH = "4d3d6bb59a8ce823fe2ee25331222838"
    TOKEN = "2051052913:AAFI68P8lri8W4k3Ol28kNkudjDv-1sATx8"  # This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    OWNER_ID = 2088106582  # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "Akshay_Hatake"
    SUPPORT_CHAT = "bardaisupport"  # Your own group for support, do not add the @
    JOIN_LOGGER = (
        -1001927205991
